...
(function (global) {
    ...
    var
        ...
        dayName = {
            ...
            d: ['N', 'P', 'W', 'Ś', 'C', 'P', 'S'],
            dd: ['Nd', 'Pn', 'Wt', 'Śr', 'Cz', 'Pt', 'Sb'],
            ddd: ['Nie', 'Pon', 'Wto', 'Śro', 'Czw', 'Pią', 'Sob']
        };
    ...
    function createMonthTable(data, option) {
        ...
        for (c = 0; c <= 6; c = c + 1) {
            ...
            //thing I changed starts here
            if (option.dayformat === "ddd"){
                td.innerHTML = dayName.ddd[c];
            }
            else if (option.dayformat === "dd"){
                td.innerHTML = dayName.dd[c];
            }
            else if (option.dayformat === "d"){
                td.innerHTML = dayName.d[c];
            }
            else{
                td.innerHTML = dayName.full[c];
            }
            //thing I changed ends here
